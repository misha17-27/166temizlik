...
import { galleryCategories, galleryImages } from "@/lib/pages-data";
...
export default function GalleryPage() {
  return (
    <SitePage active="gallery">
      <section className="bg-white pb-20 pt-16 max-md:pb-12 max-md:pt-10">
        <div className="container-shell">
          <div className="text-center">
            <h1 className="text-[42px] font-extrabold leading-tight text-black max-md:text-[32px]">Qalereya</h1>
            <p className="mt-3 text-[19px] font-bold text-[#8c8c8c] max-md:text-[16px]">Qüsursuz və Etibarlı</p>
          </div>
